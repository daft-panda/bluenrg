...
impl AddDescriptorParameters<'_> {
...
impl UpdateCharacteristicValueParameters<'_> {
    const MAX_LENGTH: usize = 255;
...
impl FindByTypeValueParameters<'_> {
    const MAX_LENGTH: usize = 255;
...
impl MultipleCharacteristicReadParameters<'_> {
    const MAX_LENGTH: usize = 255;
...
impl LongCharacteristicValue<'_> {
    const MAX_LENGTH: usize = 255;
...
impl WriteResponseParameters<'_> {
    const MAX_LENGTH: usize = 255;
...
impl DescriptorValueParameters<'_> {
    const MAX_LENGTH: usize = 255;
...
#[cfg(feature = "ms")]
impl UpdateLongCharacteristicValueParameters<'_> {
    const MAX_LENGTH: usize = 255;
